        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editWallet_naked_editText_address),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("someaddress"), closeSoftKeyboard());

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editWallet_naked_editText_address), withText("someaddress"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.editwallet_activity_fragmentContainer),
                                        0),
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.editWallet_naked_editText_address), withText("someaddress"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.check(matches(withText("someaddress")));
