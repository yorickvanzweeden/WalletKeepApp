...
public class BitfinexApiTests extends ApiServiceTest {

    public BitfinexApiTests(){
        init(MyApiCredentials.getBitfinexCredentials());
    }
    ...
    private WalletWithRelations getDefaultWallet(ExchangeCredentials exchangeCredentials){
        ...
        wallet.wallet.setExchangeName("Bitfinex");
